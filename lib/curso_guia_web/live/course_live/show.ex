              ...
              <el-tab-group>
                <div class="border-b border-gray-200">
                  <el-tab-list class="-mb-px flex space-x-8">
                    <button
                      id="tab-reviews"
                      class="border-b-2 border-transparent py-6 text-sm font-medium whitespace-nowrap text-gray-700 hover:border-gray-300 hover:text-gray-800 aria-selected:border-indigo-600 aria-selected:text-indigo-600"
                    >
                      Customer Reviews
                    </button>
                    <button
