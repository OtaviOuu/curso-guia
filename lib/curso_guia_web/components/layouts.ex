defmodule CursoGuiaWeb.Layouts do
  @moduledoc """
  This module holds layouts and related functionality
  used by your application.
  """
  use CursoGuiaWeb, :html
  ...
  def app(assigns) do
    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-6">
          ...
          <% else %>
            <.link navigate={~p"/users/log-in"} class="text-sm/6 font-semibold text-gray-900">
              Login
            </.link>
            <.link navigate={~p"/users/register"} class="text-sm/6 font-semibold text-gray-900">
              Register
            </.link>
          <% end %>
        </div>
    ...
    <main class="container mx-auto sm:px-6 lg:px-8 pt-20 flex-1">
    ...
    <footer class="bg-white mt-auto">
      <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center gap-x-6 md:order-2">
          <a href="https://github.com/otaviouu" class="text-gray-600 hover:text-gray-800">
        ...
        <p class="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0">
          &copy; 2025 "texto generico de footer".
        </p>
      </div>
    </footer>
